...
def main(test=False, league="wp2", cmds_number=0, unknown_objs=False):
    ######################################################################
...
if __name__ == "__main__":
    ...
    main(test=args.test > 0, league=args.league, cmds_number=args.test, unknown_objs=args.unknown_objs)
